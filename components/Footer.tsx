      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 md:grid-cols-2 lg:grid-cols-5 md:px-8">
        ...
        <div>
          ...
          <div className="mt-5 flex flex-wrap gap-x-4 gap-y-2 text-sm">
            <a href={siteConfig.social.instagram} className="text-white/80 hover:text-white" rel="me noreferrer" target="_blank">
              Instagram
            </a>
            <a href={siteConfig.social.linkedin} className="text-white/80 hover:text-white" rel="me noreferrer" target="_blank">
              LinkedIn
            </a>
            <a href={siteConfig.social.x} className="text-white/80 hover:text-white" rel="me noreferrer" target="_blank">
              X
            </a>
            <a href={siteConfig.social.threads} className="text-white/80 hover:text-white" rel="me noreferrer" target="_blank">
              Threads
            </a>
            <a href={siteConfig.social.youtube} className="text-white/80 hover:text-white" rel="me noreferrer" target="_blank">
              YouTube
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-white/15">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-5 py-6 text-xs text-white/70 md:flex-row md:items-center md:justify-between md:px-8">
          ...
          <p className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            <span>Ads House · ads agency · Rohtak</span>
          </p>
        </div>
      </div>
    </footer>
